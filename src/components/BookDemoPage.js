  ...
  return (
    <div style={{display:'flex' , height:'91vh' , backgroundColor:'black' , justifyContent:'space-evenly' , alignItems:'center'}}>
      <Box className='content-container' sx={{width:'40%' , height:'fit-content' , display:'flex' , flexDirection:'column' , gap:3 , marginBottom:'260px'}}>
        <Typography sx={{fontSize:'26px' , fontWeight:'bold' , color:'#66BCFF'}}>Accelerate Your AI Transformation Journey With Data Fusion</Typography>
        <Typography sx={{fontSize:'18px' , color:'white' , width:'95%'}}>Experience the power of data fusion firsthand and witness how it can propel your company's AI transformation journey to new heights. Our innovative solution automates the integration of both structured and unstructured data, empowering you to build and fine-tune multiple models for various business processes in just weeks</Typography>
        <Button variant='contained' sx={{ bgcolor: '#379AE6', color: 'white', borderRadius: '20px', width: '150px', height: '38px', textTransform: 'capitalize', fontSize: '16px' , marginTop:"20px"}}>Link</Button>
      </Box>
      ...
      <Box className='form-container' sx={{bgcolor:'whitesmoke' , width:'37%' , height:'600px' , display:'flex' , flexDirection:'column' ,
        ...
        <Box className='company-box' sx={{display:'flex' , flexDirection:'row' , gap:5 , margin:"0 auto"}}>
          <Box className='company-name'>
            <Typography>Company name<span style={{ color: 'red' }}>*</span></Typography>
          ...
          <Box className='job-title'>
            <Typography>Job Title<span style={{ color: 'red' }}>*</span></Typography>
        ...
        <Box className='choose-industry-box' sx={{display:'flex' , flexDirection:'row' , gap:5 , margin:"0 auto"}}>
          <Box className='industry'>
            <Typography>Choose your industry<span style={{ color: 'red' }}>*</span></Typography>
          ...
          <Box className='employees'>
            <Typography>No. of emplpyees<span style={{ color: 'red' }}>*</span></Typography>
            {/* <TextField InputProps={{style:{height:'40px' , width:'200px'}}}/> */}
        ...
        <Box sx={{margin:'0 auto'}}>
          <Typography>Country<span style={{ color: 'red' }}>*</span></Typography>
          {/* <TextField InputProps={{style:{width:'440px' , height:'40px'}}}/> */}
