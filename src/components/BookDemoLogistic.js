  ...
  return (
    <div style={{display:'flex' , height:'91vh' , backgroundColor:'black' , justifyContent:'space-evenly' , alignItems:'center'}}>
      <Box className='content-container' sx={{width:'40%' , height:'fit-content' , display:'flex' , flexDirection:'column' , gap:3 , marginBottom:'260px'}}>
        <Typography sx={{fontSize:'26px' , fontWeight:'bold' , color:'#66BCFF'}}>Optimizing Transportation and Logistics with Generative Intelligence</Typography>
        <Typography sx={{fontSize:'18px' , color:'white' , width:'95%'}}>Transform your transportation and logistics operations with Generative AI. Our advanced algorithms analyze complex data sets, optimize routes, and predict demand fluctuations, enabling you to streamline operations and enhance efficiency. Embrace the future of logistics with confidence and precision.</Typography>
...
export default BookDemoLogistic;
