  ...
  return (
    <div style={{display:'flex' , height:'91vh' , backgroundColor:'black' , justifyContent:'space-evenly' , alignItems:'center'}}>
      <Box className='content-container' sx={{width:'40%' , height:'fit-content' , display:'flex' , flexDirection:'column' , gap:3 , marginBottom:'260px'}}>
        <Typography sx={{fontSize:'26px' , fontWeight:'bold' , color:'#66BCFF'}}>Unlocking Financial Insights with Generative Intelligence</Typography>
        <Typography sx={{fontSize:'18px' , color:'white' , width:'95%'}}>Innovate your financial strategy with the power of Generative AI. Our cutting-edge technology analyzes market trends, predicts outcomes, and generates actionable insights, empowering you to make informed decisions with confidence. Experience the future of finance today."</Typography>
        <Button href='https://drive.google.com/file/d/1xzSEBx38CXbg_NegQ6vGupS-rGkxGLUh/view?usp=drive_link' variant='contained' sx={{ bgcolor: '#379AE6', color: 'white', borderRadius: '20px', width: '150px', height: '38px', textTransform: 'capitalize', fontSize: '16px' , marginTop:"20px"}}>Link</Button>
      </Box>
...
export default BookDemoFinancial;
