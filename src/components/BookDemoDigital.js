  ...
  return (
    <div style={{display:'flex' , height:'91vh' , backgroundColor:'black' , justifyContent:'space-evenly' , alignItems:'center'}}>
      <Box className='content-container' sx={{width:'40%' , height:'fit-content' , display:'flex' , flexDirection:'column' , gap:3 , marginBottom:'260px'}}>
        <Typography sx={{fontSize:'26px' , fontWeight:'bold' , color:'#66BCFF'}}>Elevating Digital Marketing Strategies with Generative Intelligence</Typography>
        <Typography sx={{fontSize:'18px' , color:'white' , width:'95%'}}>Supercharge your digital marketing efforts with Generative AI. Our intelligent algorithms analyze consumer behavior, predict trends, and craft compelling campaigns tailored to your audience, ensuring maximum impact and ROI. Embrace innovation and unlock new levels of success in the digital realm.</Typography>
        <Button href='https://drive.google.com/file/d/1Bo07hAMODtAu-fDK7IDM8UFwzSURLYRU/view?usp=drive_link' variant='contained' sx={{ bgcolor: '#379AE6', color: 'white', borderRadius: '20px', width: '150px', height: '38px', textTransform: 'capitalize', fontSize: '16px' , marginTop:"20px"}}>Link</Button>
      </Box>
...
export default BookDemoDigital;
