  ...
  return (
    <div style={{display:'flex' , height:'91vh' , backgroundColor:'black' , justifyContent:'space-evenly' , alignItems:'center'}}>
      <Box className='content-container' sx={{width:'40%' , height:'fit-content' , display:'flex' , flexDirection:'column' , gap:3 , marginBottom:'260px'}}>
        <Typography sx={{fontSize:'26px' , fontWeight:'bold' , color:'#66BCFF'}}>Empowering Staffing Success with Generative Intelligence</Typography>
        <Typography sx={{fontSize:'18px' , color:'white' , width:'95%'}}>Empower your staffing endeavors with Generative AI. Our innovative approach leverages data insights to streamline recruitment, match candidates with precision, and drive organizational growth. Step into a new era of staffing excellence with our cutting-edge solutions."</Typography>
...
export default BookDemoStaffing;
